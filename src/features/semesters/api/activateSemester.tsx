...
export const activateSemester = async (semesterId: string|undefined) => {
    ...
    .then((e)=>{toast.update(t, {render: `Pomyślnie aktywowano semestr - ${e.data.name}`, type: "success", theme: "colored", isLoading: false, closeButton: true, autoClose: 8000}); return e})
