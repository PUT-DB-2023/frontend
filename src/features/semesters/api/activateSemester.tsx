...
export const activateSemester = async (semesterId: string|undefined) => {
    ...
    .catch((e)=>{toast.update(t, {render: `Nie udało się aktywować semestru - ${e.response.data.name}`, type: "error", theme: "colored", isLoading: false, closeButton: true, autoClose: 5000}); return e})
