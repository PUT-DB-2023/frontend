...
export const deleteSemester = async (id: string|undefined) => {
    ...
    .catch((e)=>{toast.update(t, {render: `Nie udało się usunąć semestru - ${displayError(e.response.data)}`, type: "error", theme: "colored", isLoading: false, closeButton: true, autoClose: 8000}); return e})
