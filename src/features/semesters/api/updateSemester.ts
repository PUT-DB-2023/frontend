...
export const updateSemester = async (semester: SemesterPost) => {
    ...
    .catch((e)=>{toast.update(t, {render: `Nie udało się edytować semestru - ${displayError(e.response.data)}`, type: "error", theme: "colored", isLoading: false, closeButton: true, autoClose: 8000}); return e})
