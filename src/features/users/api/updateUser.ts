...
export const updateUserOld = async (user: OldUser, type: UserType) => {
    ...
    .then((e)=>{toast.update(t, {render: `Pomyślnie edytowano użytkownika - ${e.data.first_name} ${e.data.last_name}`, type: "success", theme: "colored", isLoading: false, closeButton: true, autoClose: 8000}); return e})
