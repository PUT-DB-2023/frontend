...
export const deleteUserOld = async (id: any, type: UserType) => {
    ...
    .catch((e)=>{toast.update(t, {render: `Nie udało się usunąć użytkownika - ${displayError(e.response.data)}`, type: "error", theme: "colored", isLoading: false, closeButton: true, autoClose: 8000}); return e})
    return response;
}