...
export const addUserOld = async (user: OldUser, type: UserType) => {
    ...
    .then((e)=>{toast.update(t, {render: "Pomyślnie dodano użytkownika", type: "success", isLoading: false, closeButton: true, autoClose: 5000}); return e})
    .catch((e)=>{toast.update(t, {render: "Nie udało się dodać użytkownika", type: "error", isLoading: false, closeButton: true, autoClose: 5000}); return e})
    return response
}