...
export const deleteEdition = async (id: string|undefined) => {
    ...
    .catch((e)=>{toast.update(t, {render: `Nie udało się usunąć edycji - ${e.data.name}`, type: "error", theme: "colored", isLoading: false, closeButton: true, autoClose: 5000}); return e})
    return response
}