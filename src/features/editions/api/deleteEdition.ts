...
export const deleteEdition = async (id: string|undefined) => {
    ...
    .catch((e)=>{toast.update(t, {render: `Nie udało się usunąć edycji - ${displayError(e.response.data)}`, type: "error", theme: "colored", isLoading: false, closeButton: true, autoClose: 8000}); return e})
    return response
}