...
export const updateServer = async (server: Server) => {
    ...
    .catch((e)=>{toast.update(t, {render: `Nie udało się edytować serwera - ${displayError(e.response.data)}`, type: "error", theme: "colored", isLoading: false, closeButton: true, autoClose: 8000}); return e})
