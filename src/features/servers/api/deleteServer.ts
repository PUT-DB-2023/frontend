...
export const deleteServer = async (id: string|undefined) => {
    ...
    .catch((e)=>{toast.update(t, {render: `Nie udało się usunąć serwera - ${e.response.data.name}`, type: "error", theme: "colored", isLoading: false, closeButton: true, autoClose: 5000}); return e})
    return response
}